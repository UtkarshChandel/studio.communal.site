          ...
          <BackgroundWrapper className="min-h-screen">
            <HeroSection className="h-full flex items-center justify-center">
              <div className="text-center max-w-4xl mx-auto px-6">
                ...
                <div className="relative bg-gradient-to-br from-blue-100/60 via-white/60 to-green-100/60 border border-blue-200/40 shadow-xl rounded-3xl p-12 overflow-hidden">
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="text-2xl md:text-3xl font-bold text-gray-800 mb-3 drop-shadow-sm">
                      Discover & Subscribe to AI Clones
                    </div>
                    <div className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl text-center">
                      Soon you'll be able to see what our community/users are
                      building & subscribe to their clones.
                    </div>
                  </div>
                </div>
              </div>
